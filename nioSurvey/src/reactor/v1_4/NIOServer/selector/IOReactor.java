package reactor.v1_4.NIOServer.selector;
...
import reactor.v1_4.NIOServer.selector.core.AbstractReactor;
...
public class IOReactor extends AbstractReactor {
	...
	private void instanceConnector(SocketChannel socket) {
		try {
			reader.getConstructor(Selector.class, SocketChannel.class)
					.newInstance(selector, socket);
